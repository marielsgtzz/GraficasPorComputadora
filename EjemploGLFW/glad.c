...
int main()
{
    ...
    texture wrapping to GL_REPEAT(default wrapping method)
    ...
    unsigned char* data =
        stbi_load("C:/Users/wpere/Desktop/Wilmer/ITAM/Docencia/Grafica/Librerias/images/
            container.jpg", &width, &height, &nrChannels, 0);
            if (data)
            {
